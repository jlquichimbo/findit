...
function dibujarReloj(h, m) {
    ...
    contenedor = contenedor + "<div class='row filaReloj'><div class='col-md-6 hours'><h2 id='hora'>" + h + "</h2></div><div class='col-md-6 minute'><h2 id='minuto'>" + m + "</h2></div></div>";
    ...
    contenedor = contenedor + "<br><div class='row filaEvento'><div class='col-md-6 colh'><label class='col-Evento' id='btnAceptar' onclick='setHora(1)'>Seleccionar</label></div><div class='col-md-6 colm'><label class='col-Evento' id='btnCancelar' onclick='cancelar(1)'>Cancelar</label></div></div>";
    ...
    contenedor = contenedor + "<div class='row filaReloj'><div class='col-md-6 hours'><h2 id='rhoraCierre'>00</h2></div><div class='col-md-6 minute'><h2 id='minutoCierre'>00</h2></div></div>";
    ...
    contenedor = contenedor + "<br><div class='row filaEvento'><div class='col-md-6 colh'><label class='col-Evento' id='btnAceptarCierre' onclick='setHora(2)'>Seleccionar</label></div><div class='col-md-6 colm'><label class='col-Evento' id='btnCancelarCierre' onclick='cancelar(2)'>Cancelar</label></div></div>";
