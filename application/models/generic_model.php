<?php
/*
 *  Modelo generico para acceso a la BD
 *  se lo carga en el controlador para acceder a sus metodos
 * 
...
class Generic_model extends CI_Model {
	...
	{            
        ...
        /*
         * Le pasamos las condiciones del selecte en $where_data
         * Example: $this->generic_model->get_data('billing_bodega', array('deleted'=>'0'), 'id,nombre', array('nombre'=>'asc'));
         */
	function get_data( $table_name, $where_data = null, $fields = '', $order_by = null, $rows_num = 0, $group_by = null )
	{
            if($where_data){
                foreach ($where_data as $key => $value) {
                    $this -> db -> where($key,$value);        
...
//            print_r($where_data);
	...
	function get_join($table_name, $where_data, $join_cluase, $fields = '', $rows_num = 0, $order_by = null, $group_by = null )
	{
