    ...
    <section class="main container well">
        <div class="row">
            ...
            <section class="col-md-8">
               <!-- <p>class="col-md-8"</p>-->
                <div class="container hidden-xs" style="height: auto; width:auto;">
                    <div class="row" >
                        <div id="carousel-example-generic" class="carousel slider" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                foreach ($anuncios as $anuncio) {
                                    ...
                                    if ($i == 0) {
                                        $item .= '<img src="' . base_url() . '/uploads/images/anuncios/' . $anuncio->img . '" alt="' . $anuncio->titulo . '" style="height: auto;">'
                                        ...
                                        $item .= '<div class="item" align="center">'
                                                . '<img src="' . base_url() . '/uploads/images/anuncios/' . $anuncio->img . '" alt="' . $anuncio->titulo . '" style="height: auto;">'
                                                . '<div class="carousel-caption">'
                                                . '<h4>' . $anuncio->titulo . '</h4>'
                                                . '<p>'
                                                . '<a class="btn btn-primary" type="button" href="' . $anuncio->url . '" target="_blank">Abre el anuncio</a>'
